...
const ConditionsPage: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                {/* Primary Meta Tags */}
                <title>Back & Spine Problems | Common Back Pain Conditions & Symptoms</title>
                <meta name="description" content="Learn about common back problems like slipped disc, curved spine, pinched nerves, and age-related back issues. Understand symptoms, risk factors, and treatment options from expert back specialists." />

                {/* Keywords Meta Tag */}
                <meta name="keywords" content="back pain conditions, slipped disc, herniated disc, curved spine, scoliosis, pinched nerve, spinal stenosis, back problems, spine problems, degenerative disc disease, back injury, spine injury, back pain symptoms" />

                {/* Open Graph / Facebook */}
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Common Back Problems & Spine Conditions | Expert Treatment Guide" />
                <meta property="og:description" content="Comprehensive guide to back and spine problems including slipped discs, curved spine, and pinched nerves. Expert information on symptoms and treatments." />
                <meta property="og:image" content="/images/conditions.jpg" />

                {/* Twitter */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Back Problems & Spine Conditions Guide" />
                <meta name="twitter:description" content="Expert guide to common back problems including slipped disc, curved spine, and pinched nerves. Know your symptoms and treatment options." />
                    ...
                    {`
          {
            ...
            "about": {
              ...
              "name": "Spine Conditions and Back Problems",
              "description": "Information about various back and spine conditions including symptoms and treatments"
            },
            "mainEntity": {
              "@type": "ItemList",
              "itemListElement": [
                {
                  "@type": "MedicalCondition",
                  "name": "Herniated Disc",
                  "alternateName": ["Slipped Disc", "Bulging Disc"],
                  "description": "Spinal disc problem where the soft center pushes through the outer layer",
                  "symptom": [
                    "Back or neck pain",
                    "Arm or leg pain",
                    "Numbness",
                ...
                },
                {
                  ...
                  "alternateName": ["Pinched Nerve in Back", "Narrow Spine"],
                  "description": "Narrowing of spaces in the spine that can put pressure on nerves",
                  "symptom": [
                    "Back pain",
                    "Numbness in legs",
                    "Balance problems"
                ...
                },
                {
                  "@type": "MedicalCondition",
                  "name": "Scoliosis",
                  "alternateName": ["Curved Spine", "Spinal Curvature"],
                  "description": "Abnormal sideways curve of the spine",
                  "symptom": [
                    "Uneven shoulders",
                    "Uneven waist",
